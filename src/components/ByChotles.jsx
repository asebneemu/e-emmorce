  ...
  return (
    <div className="w-full my-16">
      <div className="w-[80%] mx-auto flex gap-2">
        <div className="w-[20%] aspect-square bg-cover bg-center relative" style={{ backgroundImage: `url(${resim1})` }}>
        ...
        <div className="w-[20%] aspect-square bg-cover bg-center relative" style={{ backgroundImage: `url(${resim3})` }}>
          <div className="absolute inset-0 bg-black bg-opacity-0"></div>
          <div className="absolute inset-0 flex flex-col justify-center items-center text-white">
            <h2 className="text-2xl font-bold absolute top-8 transform -translate-y-1/2">CLOTHS</h2>
            <p className="text-lg absolute bottom-4 right-4">5 Items</p>
        ...
        <div className="w-[20%] aspect-square bg-cover bg-center relative" style={{ backgroundImage: `url(${resim4})` }}>
          <div className="absolute inset-0 bg-black bg-opacity-40"></div>
          <div className="absolute inset-0 flex flex-col justify-center items-center text-white">
            <h2 className="text-2xl font-bold absolute top-8 transform -translate-y-1/2">CLOTHS</h2>
            <p className="text-lg absolute bottom-4 right-4">5 Items</p>
        ...
        <div className="w-[20%] aspect-square bg-cover bg-center relative" style={{ backgroundImage: `url(${resim5})` }}>
          <div className="absolute inset-0 bg-black bg-opacity-0"></div>
          <div className="absolute inset-0 flex flex-col justify-center items-center text-white">
            <h2 className="text-2xl font-bold absolute top-8 transform -translate-y-1/2">CLOTHS</h2>
            <p className="text-lg absolute bottom-4 right-4">5 Items</p>
