...
import { shopBestsellersPantalonData } from "../../data";
import { Link } from 'react-router-dom';
import FavoriteButton from '../../components/Buttons/FavoriteButton';
import AddToCartButton from '../../components/Buttons/AddToCartButton';
import StarRating from '../../components/Buttons/StarRating';

export default function ShopBestsellersPantalon() {
    const itemsPerPage = 12;
    const totalPages = Math.ceil(shopBestsellersPantalonData.length / itemsPerPage);
        ...
        <div className="flex justify-center items-center p-4 my-20">
            <div className="w-[95%] rounded-lg p-6">
                <div className="mb-4 flex flex-col gap-10 w-[70%] mx-auto">
                    <h2 className="text-4xl font-bold mb-2 text-center">Pantalon Koleksiyonu</h2>
                </div>

                <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
                    {shopBestsellersPantalonData.slice(startIndex, endIndex).map((product) => (
