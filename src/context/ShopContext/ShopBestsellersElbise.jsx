...
import { shopBestsellersElbiseData } from "../../data";
import { Link } from 'react-router-dom';
import FavoriteButton from '../../components/Buttons/FavoriteButton';
import AddToCartButton from '../../components/Buttons/AddToCartButton';
import StarRating from '../../components/Buttons/StarRating';

export default function ShopBestsellersElbise() {
    const itemsPerPage = 12;
    const totalPages = Math.ceil(shopBestsellersElbiseData.length / itemsPerPage);
        ...
        <div className="flex justify-center items-center p-4 my-20">
            <div className="w-[95%] rounded-lg p-6">
                ...
                <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
                    {shopBestsellersElbiseData.slice(startIndex, endIndex).map((product) => (
