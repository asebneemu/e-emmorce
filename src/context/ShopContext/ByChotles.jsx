...
const ByChotles = ({
    ...
    const [selectedGender, setSelectedGender] = useState("rastgele");
    ...
    return (
        <div className="w-full my-16 flex flex-col items-center">
            ...
            {selectedGender === "erkek" && (
                <div className="w-[80%] mx-auto flex flex-wrap justify-center items-center gap-2">
                    <div onClick={() => setSelectedCategory("ceket")} className="cursor-pointer w-[45%] md:w-[20%] aspect-square h-[120%] bg-cover bg-center relative" style={{ backgroundImage: `url(${resim1})` }}>
                        <div className="absolute inset-0 bg-black bg-opacity-0"></div>
                        <div className="absolute inset-0 flex flex-col justify-center items-center text-white">
                    ...
                    <div onClick={() => setSelectedCategory("gomlek")} className="cursor-pointer w-[45%] md:w-[20%] aspect-square h-[120%] bg-cover bg-center relative" style={{ backgroundImage: `url(${resim2})` }}>
                        <div className="absolute inset-0 bg-black bg-opacity-0"></div>
                        <div className="absolute inset-0 flex flex-col justify-center items-center text-white">
                    ...
                    <div onClick={() => setSelectedCategory("takim")} className="cursor-pointer w-[45%] md:w-[20%] aspect-square h-[120%] bg-cover bg-center relative" style={{ backgroundImage: `url(${resim3})` }}>
                        <div className="absolute inset-0 bg-black bg-opacity-0"></div>
                        <div className="absolute inset-0 flex flex-col justify-center items-center text-white">
                    ...
                    <div onClick={() => setSelectedCategory("kazak")} className="cursor-pointer w-[45%] md:w-[20%] aspect-square h-[120%] bg-cover bg-center relative" style={{ backgroundImage: `url(${resim4})` }}>
                        <div className="absolute inset-0 bg-black bg-opacity-0"></div>
                        <div className="absolute inset-0 flex flex-col justify-center items-center text-white">
                    ...
                    <div onClick={() => setSelectedCategory("erkekAyakkabi")} className="cursor-pointer w-[45%] md:w-[20%] aspect-square h-[120%] bg-cover bg-center relative" style={{ backgroundImage: `url(${resim7})` }}>
                        <div className="absolute inset-0 bg-black bg-opacity-0"></div>
                        <div className="absolute inset-0 flex flex-col justify-center items-center text-white">
                            <h2 className="text-2xl font-bold">Ayakkabı</h2>
